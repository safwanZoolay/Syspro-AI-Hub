...
// Set to true to use real n8n webhooks, false for simulation
const USE_REAL_WEBHOOKS = process.env.NEXT_PUBLIC_USE_REAL_WEBHOOKS === 'true';
      ...
      if (USE_REAL_WEBHOOKS) {
        ...
        try {
          updateExecution(execution.id, {
            status: 'running',
            statusMessage: 'Connecting to n8n workflow...',
            progress: 10,
          });
